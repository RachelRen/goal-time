...
const config = {
    ...
    resolve: {
        alias: {
            ...
            Page: path.resolve(__dirname, './static/src/page'),
            Components: path.resolve(__dirname, './static/src/components'),
            Util: path.resolve(__dirname, './static/src'),
            Redux: path.resolve(__dirname, './static/src/redux'),
            Images: path.resolve(__dirname, './static/src/assets/images'),
            // Src: path.resolve(__dirname, './static/src'),
        },
